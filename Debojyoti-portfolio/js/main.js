...
// Function to open the popup after scrolling for 6 seconds
function openPopupAfterDelay() {
  ...
  // Attach the scroll-triggered popup to the window's scroll event
...
function resetForm(event) {
  ...
  document.getElementById("appointmentForm").addEventListener("reset", resetForm);